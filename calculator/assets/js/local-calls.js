function calculate() {
    ...
    if ($( "#myform" ).valid()) {
        ...
        /* if operator was "Add" the add the two operands */
        if (operator == "Add") {
            result = operand1fp + operand2fp;
        }
        
        /* if operator was "Subtract" the subtract the two operands */
        if (operator == "Subtract") {
            result = operand1fp - operand2fp;
        }
        
        /* if operator was "Multiply" the Multiply the two operands */
        if (operator == "Multiply") {
            result = operand1fp * operand2fp;
        }
        
        /* if operator was "Divide" the Divide the two operands */
        if (operator == "Divide") {
            result = operand1fp / operand2fp;
        }
